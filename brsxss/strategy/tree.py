...
def create_default_strategy() -> StrategyTree:
    ...
    html_ctx = root.add_child(StrategyNode(
        id="ctx-html",
    ...
    js_ctx = root.add_child(StrategyNode(
        id="ctx-js",
        type=NodeType.CONTEXT,
    ...
    attr_ctx = root.add_child(StrategyNode(
        id="ctx-attr",
        type=NodeType.CONTEXT,
    ...
    url_ctx = root.add_child(StrategyNode(
        id="ctx-url",
        type=NodeType.CONTEXT,
        name="URL Context",
    ...
    for ctx in [html_ctx, js_ctx, attr_ctx, url_ctx]:
        waf_branch = ctx.add_child(StrategyNode(
            id=f"{ctx.id}-waf",
        ...
        no_waf = ctx.add_child(StrategyNode(
            id=f"{ctx.id}-nowaf",
            type=NodeType.CONDITION,
            name="No WAF",
            condition="!waf_detected",
        ...
        waf_branch.add_child(StrategyNode(
    ...
    # HTML context
    html_ctx.children[-1].add_child(StrategyNode(
        id="html-script",
        type=NodeType.PAYLOAD,
        name="Script Tag",
    ...
    # JS context
    js_ctx.children[-1].add_child(StrategyNode(
        id="js-breakout",
        type=NodeType.PAYLOAD,
    ...
    # Attribute context
    attr_ctx.children[-1].add_child(StrategyNode(
        id="attr-event",
        type=NodeType.PAYLOAD,
        name="Event Handler",
    ...
    # URL context
    url_ctx.children[-1].add_child(StrategyNode(
        id="url-javascript",
        type=NodeType.PAYLOAD,
