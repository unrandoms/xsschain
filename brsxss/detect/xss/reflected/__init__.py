...
"""
BRS-XSS Core Module - COMPATIBILITY LAYER

This module re-exports from detect/xss/reflected/ for backward compatibility.
New code should import from brsxss.detect.xss.reflected directly.
...
DEPRECATED: Use brsxss.detect.xss.reflected instead
"""
